...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-7vt0YDVZ.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-LQ-ucdAP.js").then((n2) => n2.r),
    import("./start-BB3qtgT-.js"),
...
var ROUTER_BASEPATH = "carewise-connect-live";
var SERVER_FN_BASE = "/carewise-connect-live/_serverFn/";
