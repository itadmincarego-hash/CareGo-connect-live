...
const alerts = [
  { id: "a1", severity: "high", title: "Possible fall detected — Living Room", time: "Resolved 2d ago", status: "resolved", responder: "Emergency contact + Agent dispatched" },
  { id: "a2", severity: "medium", title: "Unusual inactivity — 2h 40m", time: "Yesterday 14:20", status: "acknowledged", responder: "Sarah W. acknowledged" },
  { id: "a3", severity: "low", title: "Medication reminder missed", time: "Today 13:00", status: "open", responder: "AI follow-up scheduled" }
];
const aiDecisions = [
...
const agents = [
  ...
  { id: "ag3", name: "Priya Nair", role: "Medication & Companionship", rating: 5, jobs: 423, eta: 31, distance: 7, photo: "https://api.dicebear.com/7.x/avataaars/svg?seed=Priya&backgroundColor=d1d4f9", org: "Avon Home Care", verified: ["DBS", "Training", "Right to Work", "First Aid"] }
];
...
const marketplaceListings = [
  ...
  { id: "m3", carer: "Marcus Bell", org: "Independent", role: "Night Response", rate: 26, available: "Nights only", rating: 4.7, skills: ["Emergency response", "First Aid"], distance: 2 },
  { id: "m4", carer: "Olu Akande", org: "Severn Care Co.", role: "Senior Carer", rate: 24, available: "Flexible", rating: 5, skills: ["Palliative", "Medication"], distance: 4.8 }
];
